...
Two of the four methods below act on the edge set alone, replacing $\mathcal{E}$ with a subset
...
The drop rate is the only freely tunable compression parameter in the family, so its value
...
% TODO: rerun random edge dropout at 0.419, or drop the spanning-forest pairing.
...
The retention fraction $\kappa$ is the method's compression knob and is set to $\kappa = 0.8$,
