...
\todo{make much more concise. keep full text commented out. epoch wall time is not useful since i varied between experimetns i have benchmarking at the end for througput per rgaph etc. }
\todo{mention briefly which measurements answer which question}