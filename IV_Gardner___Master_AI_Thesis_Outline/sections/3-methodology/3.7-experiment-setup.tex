...
\todo{done really need to restate hypithesis more so say how this addresses each RQ or how i iwll address them}

\todo{this paragraph seems unnecessary and wdym known}
...
\todo{dont discuss limits outside of limitatoin this much in my opinion}
...
\todo{all these specific hyperparemeters like train split etc.
 how can i best display this more concisely idk if it should really be takign up this much space in my methodlogy or if this is more appendix info}
...
alone would suggest.
\todo{shoudl this be here or in reproducability?}

% TODO: library versions, the synthesis tool version, and the total wall-clock budget. This should go to appendix start ordering my appendix by things that will most likely end up there


\todo{keep full text commented out. make more concise for this turn in. }