...
%TODO no need for structural bias how is that relevant
...
%TODO wtf do you mean circuit interface
...
%TODO did you define what inversion is and what a pu and and gate and constant is?
...
%TODO preliminaries should jus tbe introducing concept mention of how to convert it or anythign abotu one hot shoudl not be here
...
%TODO shoudl not mention anything about the thesis content this is prelminaries. should introduce the relevant info nto argue or connect it 
...
%TODO preliminaries is just abotu concept introduction not the thesis content. 
...
%TODO what is the relevance of this?
...
%TODO what is the reconvergence important? maybe it should be explained more in the context of the way it is used in this thesis like the relevant info one needs for being able ot handle its mention later on in the thesis
...
%TODO what do you mean by interface i have never heard this term used before. 
...
%TODO this should be way less thesis related how i apply the ML in my project to AIGs should not be introduced or explained in preliminaires while introducing AIGS!!!
%
