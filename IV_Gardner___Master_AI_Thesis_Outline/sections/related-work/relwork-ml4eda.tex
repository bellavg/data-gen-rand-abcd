...
\label{sec:relwork}
\todo{this setnence is not subtle enough imo}
...
\todo{order of subsections seems odd here shoudl be
tasks it is used in then maybe datset then maybe eval protocols and unseen design then baselines?
also think about the tasks we elaborate on and if they are relevant we should list all tasks that ML 
is used with but also instead of ML4EDA mayeb say ML4LS and specify AIG. but tasks missing are like AIG generation etc. }
