"""Vendored from zyzheng17/DeepGate4-ICLR-25, src/models/mlp.py.

Source: https://github.com/zyzheng17/DeepGate4-ICLR-25/blob/master/src/models/mlp.py
...
Unmodified apart from deleting `import torch`, which upstream imports but never
references in this file (ruff F401). No behavioural change.

Used by dg2.py's `readout_prob`.
"""
