...
├─ synScripts/                    # zipped synthesis scripts and optimization runner scripts
|  ├─ ...
│  ├─ {design}.zip                # synthesis recipes (inside: abc{recipe_id}.script)
│  └─ optimization/
│     └─ {algorithm}/
│        └─ {design}.zip          # inside: optimizeBulk_{algorithm}_{design}_{base|tier1|tier2}.sh
