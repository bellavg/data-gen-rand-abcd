...
echo "=========================================="
echo "STEP 1/5: Pre-check Tier-1 graph completeness"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "STEP 2/5: Populate Tier-1 metadata CSV rows"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "STEP 3/5: Verify CSV population (tier0 + tier1)"
echo "=========================================="
...
for design in designs_file.read_text(encoding="utf-8").splitlines():
	...
	with csv_path.open("r", newline="", encoding="utf-8") as handle:
		...
		for row in reader:
			...
			# tier0 rows are expected to be algorithm-empty and tier_id either 0 or empty
...
echo ""
echo "=========================================="
echo "STEP 4/5: Dataset-wide stats report"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "STEP 5/5: Timestamped FULL_DATASET backup ZIP"
echo "=========================================="
