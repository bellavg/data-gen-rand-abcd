...
echo "  • Statistics capture at each synthesis step (print_stats only)"
echo "  • Automatic AIG file generation per synthesis step"
echo "  • Post-synthesis metadata collection using job_5_collect_metadata.sh"
...
echo "  Synthesis will generate log files and AIG zip files"
echo "  After synthesis: Run job_5_collect_metadata.sh to extract circuit statistics"
echo "  Metadata will be saved to:"
