...
echo "  • Post-synthesis metadata collection using job_6_collect_metadata.sh"
...
echo "  After synthesis: Run job_6_collect_metadata.sh to extract circuit statistics"
