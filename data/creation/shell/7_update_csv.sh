#!/bin/bash
#SBATCH --job-name=6_make_csv_all
...
#SBATCH --array=0-54
#SBATCH --output=logs/7_csv/csv_%A_%a.out

# --- Safety and Environment ---
set -euo pipefail

# Load required modules (Matching your cluster's 2025 environment)
module purge
module load 2025
...
echo "=================================================="
echo " JOB 6: Generating Multi-Tier CSV for $DESIGN"
echo " Time: $(date)"
